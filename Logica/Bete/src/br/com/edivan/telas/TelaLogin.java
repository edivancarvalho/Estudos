...
public class TelaLogin extends javax.swing.JFrame {
    ...
    public void logar() {
        ...
        String sql = "select * from alunos where alu_nome =? and alu_cpf =?";
        try {
    ...
    public TelaLogin() {
        ...
        // a linha abaixo server de apoio ao statusu da conexao;
        //System.out.println(conexao);
        if (conexao != null) {
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/edivan/icones/dbok.png")));
            lblStatus.setText(" Onlline");
        } else {
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/edivan/icones/dberror.png")));
            lblStatus.setText(" OffLine");
        }
        // altera o nome da lblstatus --> lblStatus.setText("Não conectado - Ligar para suporte.");
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(493, 292));
